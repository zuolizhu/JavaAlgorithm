...
cd target
jar -xvf ZuoliZhu001-project4PointEnclosure.war
cd ..


:run
REM build up the classpath 
REM arg1 is the name of the class to run, including the full package name (e.g. project4PointEnclosure.MyClass)
